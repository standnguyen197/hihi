            ...
            <div class="liveComment">
               ...
               <div style="background: #FFF;border:1px solid #dddee1;">
                    <Tabs>
                        ...
                        <TabPane label="SẢN PHẨM KẾ TIẾP" icon="cube">
                            Hi mình là Cu!
                        </TabPane>
                    </Tabs>
                </div>
        ...
        <div style="flex:8;">
            ...
            <div class="liveCodeProduct">
                ...
                <div class="avatarProduct" style="overflow: hidden;">
                    <a href="javascript:void(0)"  @click="previewImage = true"></a>
                </div>
            </div>
        ...
        getLive(){
                ...
                LiveComments.addEventListener('open', function(event) {
                    ...
                    //============================= NHẬN DATA BÌNH LUẬN ===============================//
                        ...
                        _this.$socket.emit('nowCommentFromClient', {messageFB,nameFB,avatarFB,idFBSys,idPartner})
                    });
